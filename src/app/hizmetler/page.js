        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            {PACKAGES.map((pkg, i) => (
              ...
              >
                <div className={`absolute inset-0 rounded-[2.5rem] bg-gradient-to-b ${pkg.popular ? 'from-indigo-500 via-purple-500 to-indigo-500' : 'from-white/10 to-white/5'} opacity-100 transition-opacity`}></div>

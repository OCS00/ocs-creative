           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                 ...
                 <p className="text-gray-400 text-lg leading-relaxed">
                    Dijital dünyada "var olmak" artık yeterli değil. Siteniz hızlı, güvenli ve ikna edici olmalı. 
                    Biz, bir freelancer gibi değil, sizin **dijital departmanınız** gibi çalışıyoruz. 

...
import { ArrowLeft, ExternalLink, Calendar, User, Layers, BarChart3, Target, Zap } from "lucide-react";
...
export default function ProjectDetail() {
  ...
  useEffect(() => {
    const fetchProject = async () => {
      // YENİ SORGUMUZ: Tüm yeni alanları (stats, gallery, challenge vs.) çekiyoruz
